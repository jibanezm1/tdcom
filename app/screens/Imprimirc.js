...
export default function ImprimirScreen (props){
  ...
  const [terminado, setTerminado ] = useState(true);
    ...
    const dire = estado.url+"/dte/dte_emitidos/pdf/"+resultado.dte+"/"+resultado.folio+"/"+resultado.certificacion+"/"+resultado.emisor+"/"+resultado.fecha+"/"+resultado.total;
         ...
         const giro =  quitar(contri.giro);
          ...
          await BluetoothEscposPrinter.printColumn(columnWidths,
            ...
            for(let i in rows){
              ...
              await BluetoothEscposPrinter.printColumn(columnWidths,
                [BluetoothEscposPrinter.ALIGN.LEFT, BluetoothEscposPrinter.ALIGN.CENTER, BluetoothEscposPrinter.ALIGN.CENTER, BluetoothEscposPrinter.ALIGN.RIGHT],
                [row.NroLinDet.toString(),  row.NmbItem.toString().substr(0, 4), row.QtyItem.toString(), row.PrcItem.toString()], {});
          ...
          await  BluetoothEscposPrinter.printText("Total: "+resultado.total+"\r\n", {});
    ...
    const glosa = async (item) => {
      await BluetoothEscposPrinter.printColumn(columnWidths,
        [BluetoothEscposPrinter.ALIGN.LEFT, BluetoothEscposPrinter.ALIGN.CENTER, BluetoothEscposPrinter.ALIGN.CENTER, BluetoothEscposPrinter.ALIGN.RIGHT],
        [item.NroLinDet.toString(),  item.NmbItem.toString().substr(0, 4), item.QtyItem.toString(), item.PrcItem.toString()], {});
